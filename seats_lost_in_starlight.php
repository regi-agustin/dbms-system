...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'book_seats') {
    ...
    try {
        ...
        $seatTixNumber = 'LSTARLIGHT-' . str_pad($or_id, 3, '0', STR_PAD_LEFT);
        ...
        $showtime_id = 3; // Set your showtime ID here
    ...
    <div class="main-container">
        ...
        <img src="images/3.jpg" alt="Lost in Starlight" class="movie-poster">
            <div class="movie-details">
                ...
                <div class="movie-title">Cinema 4, (3D) LOST IN STARLIGHT</div>
                <div class="movie-rating"> RATED PG</div>
                <div class="showtime">Friday, June 20, 2025 3:00 PM</div>
            ...
            <div class="modal-body">
                <div class="confirmation-details">
                    <div class="detail-row">
                        ...
                        <span class="detail-value">LOST IN STARLIGHT (3D)</span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">June 20, 2025 - 3:00 PM</span>
                    </div>
                    <div class="detail-row">
