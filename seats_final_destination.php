...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'book_seats') {
    ...
    try {
        ...
        $seatTixNumber = 'FDESTINATION-' . str_pad($or_id, 3, '0', STR_PAD_LEFT);
        ...
        $showtime_id = 1; // Set your showtime ID here
    ...
    <div class="main-container">
        ...
        <img src="images/1.jpg" alt="Final Destination Bloodlines" class="movie-poster">
            <div class="movie-details">
                ...
                <div class="movie-title">Cinema 3, (IMAX 2D) FINAL DESTINATION</div>
                <div class="movie-rating">R-18 (Restricted 18)</div>
                <div class="showtime">Friday, June 20, 2025 9:00 AM</div>
                <div class="ticket-price">Ticket Price: Php350.00</div>
            </div>
        </div>
            ...
            <div class="modal-body">
                <div class="confirmation-details">
                    <div class="detail-row">
                        ...
                        <span class="detail-value">FINAL DESTINATION (IMAX 2D)</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Cinema:</span>
                        <span class="detail-value">Cinema 3, Bonifacio High Street</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Showtime:</span>
                        <span class="detail-value">June 20, 2025 - 9:00 AM</span>
                    </div>
                    <div class="detail-row">
