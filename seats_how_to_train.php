...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'book_seats') {
    ...
    try {
        ...
        $seatTixNumber = 'HTTYD-' . str_pad($or_id, 3, '0', STR_PAD_LEFT);
        ...
        $showtime_id = 6; // Set your showtime ID here
    ...
    <div class="main-container">
        ...
        <img src="images/6.jpg" alt="How to Train Your Dragon" class="movie-poster">
            <div class="movie-details">
                ...
                <div class="movie-title">Cinema 4, (3D) HOW TO TRAIN YOUR DRAGON</div>
                <div class="movie-rating">R-13 (Restricted 13)</div>
                <div class="showtime">Saturday, June 21, 2025 12:00 PM</div>
            ...
            <div class="modal-body">
                <div class="confirmation-details">
                    <div class="detail-row">
                        ...
                        <span class="detail-value">HOW TO TRAIN YOUR DRAGON (3D)</span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">June 21, 2025 - 12:00 PM</span>
                    </div>
                    <div class="detail-row">
