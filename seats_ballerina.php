...
<style>
    ...
    * {
    ...
    .seat.occupied {
        background-color:rgb(230, 60, 60); /* muted orange */
        border-color:rgb(223, 39, 39);
        cursor: not-allowed;
        filter: grayscale(65%);
        box-shadow: none;
    }
...
<body>
    <div class="main-container">
        <div class="movie-info">
            ...
            <div class="movie-details">
                ...
                <div class="showtime">Friday, June 20, 2025 6:00 PM</div>
            ...
            <div class="modal-body">
                <div class="confirmation-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">June 20, 2025 - 6:00 PM</span>
                    </div>
                    <div class="detail-row">
    ...
    <script>
        ...
        window.location.href = `payment.php?total=${totalPrice}&movie=seats_ballerina`;
        }
