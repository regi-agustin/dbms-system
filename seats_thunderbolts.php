...
<body>
    <div class="main-container">
        <div class="movie-info">
            ...
            <div class="movie-details">
                ...
                <div class="movie-title">Cinema 1, (IMAX 2D) THUNDERBOLTS</div>
            ...
            <div class="modal-body">
                <div class="confirmation-details">
                    <div class="detail-row">
                        ...
                        <span class="detail-value">THUNDERBOLTS (IMAX 2D)</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Cinema:</span>
                        <span class="detail-value">Cinema 1, Bonifacio High Street</span>
                    </div>
                    <div class="detail-row">
    ...
    <script>
        ...
        window.location.href = `payment.php?total=${totalPrice}&movie=seats_thunderbolts`;
        }
