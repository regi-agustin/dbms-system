...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'book_seats') {
    ...
    try {
        ...
        $seatTixNumber = 'TBOLTZ-' . str_pad($or_id, 3, '0', STR_PAD_LEFT);
        ...
        $showtime_id = 4; // Set your showtime ID here
...
<body>
    <div class="main-container">
        ...
        <img src="images/7.jpg" alt="Thundeboltz" class="movie-poster">
            <div class="movie-details">
                <h2>Bonifacio High Street</h2>
                <div class="movie-title">Cinema 4, (2D/4DX) THUNDERBOLTS</div>
                <div class="movie-rating">R-16 (Restricted 16)</div>
                <div class="showtime">Saturday, June 21, 2025 3:00 PM</div>
            ...
            <div class="modal-body">
                <div class="confirmation-details">
                    <div class="detail-row">
                        ...
                        <span class="detail-value">THUNDERBOLTS (4DX)</span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">June 21, 2025 - 3:00 PM</span>
                    </div>
                    <div class="detail-row">
