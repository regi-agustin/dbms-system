...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'book_seats') {
    ...
    try {
        ...
        $seatTixNumber = 'FSTREET-' . str_pad($or_id, 3, '0', STR_PAD_LEFT);
        ...
        $showtime_id = 8; // Set your showtime ID here
    ...
    <div class="main-container">
        ...
        <img src="images/8.jpg" alt="Fear Street: Prom Queen" class="movie-poster">
            <div class="movie-details">
                ...
                <div class="movie-title">Cinema 3, (2D) FEAR STREET: PROM QUEEN</div>
                <div class="movie-rating">R-18 (Restricted 18)</div>
                <div class="showtime">Saturday, June 21, 2025 6:00 PM</div>
            ...
            <div class="modal-body">
                <div class="confirmation-details">
                    <div class="detail-row">
                        ...
                        <span class="detail-value">FEAR STREET: PROM QUEEN (2D)</span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">June 21, 2025 - 6:00 PM</span>
                    </div>
                    <div class="detail-row">
