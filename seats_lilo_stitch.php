...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'book_seats') {
    ...
    try {
        ...
        $seatTixNumber = 'LSTITCH-' . str_pad($or_id, 3, '0', STR_PAD_LEFT);
        ...
        $showtime_id = 2; // Set your showtime ID here
    ...
    <div class="main-container">
        ...
        <img src="images/2.jpg" alt="Lilo & Stitch" class="movie-poster">
            <div class="movie-details">
                ...
                <div class="movie-title">Cinema 2, (IMAX 3D) LILO & STITCH</div>
                <div class="movie-rating">RATED G</div>
                <div class="showtime">Friday, June 20, 2025 12:00 PM</div>
            ...
            <div class="modal-body">
                <div class="confirmation-details">
                    <div class="detail-row">
                        ...
                        <span class="detail-value">LILO & STITCH (IMAX 3D)</span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">June 20, 2025 - 12:00 PM</span>
                    </div>
                    <div class="detail-row">
